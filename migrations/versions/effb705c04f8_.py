...
def upgrade():
    ...
    sa.Column('contents', sa.BLOB(), nullable=False),
    ...
    sa.Column('difficulty', sa.Enum('low', 'average', 'high'), nullable=True),
    sa.Column('quality', sa.Enum('low', 'average', 'high'), nullable=True),
    sa.Column('source_code', sa.Text(), nullable=True),
